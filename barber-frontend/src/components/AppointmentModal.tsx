...
const AppointmentModal: React.FC<AppointmentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-hidden">
      <div className="bg-white dark:bg-treservi-card-dark w-full sm:w-[min(42rem,92vw)] sm:rounded-[32px] shadow-2xl overflow-hidden h-screen sm:h-auto sm:max-h-[90vh] flex flex-col">
        {/* Fixed Header */}
        <div className="flex-shrink-0 bg-white/95 dark:bg-treservi-card-dark/95 backdrop-blur border-b border-gray-100 dark:border-gray-800 px-4 sm:px-6 py-4 sm:py-5">
        ...
        {/* Fixed Footer */}
        <div className="flex-shrink-0 bg-white/95 dark:bg-treservi-card-dark/95 backdrop-blur border-t border-gray-100 dark:border-gray-800 px-4 sm:px-6 py-2.5 xs:py-3 flex items-center justify-end gap-2 xs:gap-3 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] xs:pb-[calc(env(safe-area-inset-bottom)+0.75rem)]">
          <button
            type="button"
            onClick={onClose}
