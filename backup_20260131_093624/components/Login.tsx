        ...
        <div className="relative z-10 w-full max-w-md p-4">
            <div className="bg-white dark:bg-treservi-card-dark rounded-[48px] shadow-2xl p-8 md:p-12 border border-gray-100 dark:border-gray-800/50 backdrop-blur-xl animate-in fade-in zoom-in duration-500">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 tracking-tight">Admin Portal</h1>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Manage your salon with Treservi</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                        <div className="relative group">
                            ...
                            <input 
                                ...
                                placeholder="salon@treservi.com"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <a href="#" className="text-sm text-gray-400 hover:text-treservi-accent transition-colors font-medium">Forgot password?</a>
                    </div>
            ...
            <p className="text-center text-gray-400 text-xs mt-8">
                &copy; 2024 Treservi Dashboard. All rights reserved.
            </p>
        </div>
    </div>
  );
